import {
  ...
  export default function AcademicProjects({ title, projects  }) {
    useEffect(() => {
      AOS.init({
        disable: function () {
          var maxWidth = 768
    ...
    return (
      <div className="w-full space-y-10">
        ...
        <div className="h-full w-full space-y-10 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-2 gap-10">
